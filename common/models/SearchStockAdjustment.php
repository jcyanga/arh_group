...
/**
 * SearchStockAdjustment represents the model behind the search form about `common\models\StockAdjustment`.
 */
class SearchStockAdjustment extends StockAdjustment
{
    /**
     * @inheritdoc
     */
