...
<!-- , 'class' => 'form-inline' -->
    ...
    <div class="col-md-3">
        <?= $form->field($model, 'supplier_code')->textInput(['placeholder' => 'Enter Supplier Code here...'])->label(false) ?>
    </div>

    <div class="col-md-3">
        <?= $form->field($model, 'supplier_name')->textInput(['placeholder' => 'Enter Supplier Name here...'])->label(false) ?>
    </div>
