...
<!-- , 'class' => 'form-inline' -->
    ...
    <div class="col-md-3">
        <?= $form->field($model, 'code')->textInput(['placeholder' => 'Enter Branch Code here...'])->label(false) ?>
    </div>
    
    <div class="col-md-3">
        <?= $form->field($model, 'name')->textInput(['placeholder' => 'Enter Branch Name here...'])->label(false) ?>
    </div>
