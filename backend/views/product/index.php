        ...
        <?php if( !empty($getProduct) ): ?>
            <?php foreach( $getProduct as $row){ ?>
                <tr class="even_odd pointer">
                    ...
                    <td class="tblalign_center" ><?php echo $row['unit_of_measure'];  ?></td>
                    <td class="last tblalign_center">
                        ...
                        <a href="?r=product/update&id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="Update Record" ><li class="fa fa-pencil-square"></li> </a> | 
