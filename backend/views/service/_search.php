...
<!-- , 'class' => 'form-inline' -->
    ...
    <div class="col-md-3">
        <?= $form->field($model, 'service_category_id')->dropDownList($dataServiceCategory)->label(false) ?>
    </div>

    <div class="col-md-3">
        <?= $form->field($model, 'service_name')->textInput(['placeholder' => 'Enter Name here...'])->label(false) ?>
    </div>
