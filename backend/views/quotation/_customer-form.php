...
<div id="companyInformation">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <textarea name="company_address" rows="1" class="form_input form-control" placeholder="Write Company address here." id="companyAddress" ></textarea>
        </div>
    </div>
    <br/>
...
<div id="customerInformation">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <label class="form_label">ADDRESS</label>
            <textarea name="person_address" rows="1" class="form_input form-control" placeholder="Write Customer address here." id="customerAddress" ></textarea>
        </div>
    </div>
    <br/>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <?= $form->field($model, 'race_id')->dropDownList($dataRace, ['style' => 'width:100%;', 'class' => 'form_input select2_single', 'data-placeholder' => 'CHOOSE RACE HERE', 'id' => 'customerRace' ])->label(false) ?>
        </div>
...
<div class="row">
    ...
    <div class="col-md-4">
        <?= Html::Button('<li class=\'fa fa-save\'></li> Save New Record', ['class' => 'form-btn btn btn-primary', 'id' => 'submitCustomerByQuoteForm' ]) ?>
