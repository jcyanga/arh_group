...
<br/>
 ...
 <div class="form-title-container">
    <span class="form-header"><h4><i class="fa fa-user"></i> View Module Information</h4></span>
 </div>      
 <hr/>
 ...
 <div class="col-md-12">
    <div style="text-align: right;">
        ...
        <?= Html::a( '<i class="fa fa-pencil-square"></i> Update', '?r=modules/update&id=' . $model->id, ['class' => 'form-btn btn btn-info']); ?>
