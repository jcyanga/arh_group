                        ...
                        <div style="width: 60%;"  class="col-md-8">
                            <div class="row branchcustomerContainer" >
                                <div class="col-md-12 branchName">
                                    <b> <?= Html::encode($iRow['name']) ?> </b> 
                                </div>
                                <div class="col-md-12 addressInfo">
                                    <?= Html::encode($iRow['address']) ?>
                                </div>
                            </div>
                            <div class="row customerInfoContainer" >
                                <?php if($iRow['type'] == 1): ?>
                                    <div class="col-md-12 customerName">
                                        <b>Name : </b> <?= Html::encode($iRow['company_name']) ?>
                                    </div>
                                    <div class="col-md-12 customerAddressInfo">
                                        <b>Address : </b> <?= Html::encode($iRow['customerAddress']) ?>
                                    </div>
                                <?php else: ?>
                                    <div class="col-md-12 customerName">
                                        <b>Name : </b> <?= Html::encode($iRow['fullname']) ?>
                                    </div>
                                    <div class="col-md-12 customerAddressInfo">
                                        <b>Address : </b> <?= Html::encode($iRow['customerAddress']) ?>
                                    </div>
                    ...
                    <div class="row jobsheetinvoiceLabel" >
                     ...
                     <div class="col-md-6">
                         ...
                         <div class="col-md-12 jobsheetinvoiceComeIn">
                            &nbsp; <?= Html::encode(date('d M Y H:i:s', strtotime($iRow['come_in']))) ?>
                         </div>
                         <br/>

                         <div class="col-md-12 jobsheetinvoiceComeOut">
                            &nbsp; <?= Html::encode(date('d M Y H:i:s', strtotime($iRow['come_out']))) ?>
                         </div>
                         <br/>
    ...
    <tr class="details">
        ...
        <table border="1" class="receiptorderTable" cellspacing ="0" cellpadding ="0" >
            <tr>
                ...
                <td class="servicespartsLists" id="invoicesubTableInfo" ><b>$ <?php echo number_format($iRow['grand_total'],2) ?></b></td>
            </tr>
            <tr>
                <td class="servicespartsLists" id="invoicesubTableLabel" ><b>Discount</b></td>
                <td class="servicespartsLists" id="invoicesubTableInfo" ><b> <?php echo number_format($iRow['discount_amount'],2); ?></b></td>
            </tr>
            <tr>
                <td class="servicespartsLists" id="invoicesubTableLabel" ><b>Redeem Points</b></td>
                <td class="servicespartsLists" id="invoicesubTableInfo" ><b> <?php echo $iRow['points_redeem']; ?></b></td>
            </tr>
            <tr>
                <td class="servicespartsLists" id="invoicesubTableLabel" ><b>GST(7.00%)</b></td>
                <td class="servicespartsLists" id="invoicesubTableInfo" ><b> <?php echo number_format($iRow['gst'],2); ?></b></td>
            </tr>
            <tr>
                <td class="servicespartsLists" id="invoicesubTableLabel" ><b>Nett Total</b></td>
                <td class="servicespartsLists" id="invoicesubTableInfo" ><b>$ <?php echo number_format($iRow['net'],2); ?></b></td>
            </tr>
        </table>
    </tr>
