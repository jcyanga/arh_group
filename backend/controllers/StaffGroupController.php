...
class StaffGroupController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        foreach ( $userRoleArray as $uRId => $uRName ){ 
            $permission = UserPermission::find()->where(['controller' => 'StaffGroup'])->andWhere(['role_id' => $uRId ] )->all();
            $actionArray = [];
    ...
    public function actionIndex()
    {
        ...
        if( !empty(Yii::$app->request->get('SearchStaffGroup')['name'])) {
            $getStaffGroup = $searchModel->searchFullName(Yii::$app->request->get('SearchBranch')['fullname']);
